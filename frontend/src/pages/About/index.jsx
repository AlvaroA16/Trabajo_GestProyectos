...
export default function About() {
  return (
    <main className="about-page">
      <h1>Sobre Decide Hoy</h1>
      <section className="about-page__section">
        <h2>¿Qué es Decide Hoy?</h2>
        <p>
          Decide Hoy es una plataforma de orientación vocacional dirigida a estudiantes de 4to y 5to
      ...
      <section className="about-page__section about-page__disclaimer">
        <h2>Importante</h2>
        <p>
          Decide Hoy <strong>no gestiona matrículas universitarias</strong>. Para inscribirte en
